...
@Entity
@DiscriminatorValue("SLOTH_BEAR")
public class SlothBearMarker extends AnimalMarker{
	
	public SlothBearMarker() {
	        super();
	}
	
	public SlothBearMarker(NationalPark nationalPark, Double latitude, Double longitude,
